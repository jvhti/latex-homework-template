...
\newcommand{\enterProblemHeader}[1]{
    \nobreak\extramarks{}{Problema \arabic{#1} continua na próxima página\ldots}\nobreak{}
    \nobreak\extramarks{Problema \arabic{#1} (continuação)}{Problema \arabic{#1} continua na próxima página\ldots}\nobreak{}
}
...
\newcommand{\hmwkDueDate}{27/06/2018}
\newcommand{\hmwkClass}{Cálculo}
\newcommand{\hmwkClassTime}{Seção A}
\newcommand{\hmwkClassInstructor}{Professor Isaac Newton}
\newcommand{\hmwkAuthorName}{\textbf{Autor 1} \and \textbf{Autor 2}}
...
\title{
    ...
    \normalsize\vspace{0.1in}\small{Fazer\ até\ \hmwkDueDate\ às 15:10}\\
...
\begin{homeworkProblem}
    Dê uma constante apropriada \(c\) de modo que \(f(n) \leq c \cdot
    g(n)\) para todo \(n > 1\).
    ...
    Nos resolvemos cada solução algebraicamente para determinar a possível constante
    \(c\).
    \\
    ...
    Assim um \(c\) válido pode ser quando \(c = 2\).
    \\
